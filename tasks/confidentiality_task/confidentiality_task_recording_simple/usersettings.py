...
STIMULUS_CORRECT = {"grating_sf": 0.002, "grating_ori": 0.0, "grating_size": 45.0, "grating_speed": 0.015}

STIMULUS_WRONG = {"grating_sf": 0.002, "grating_ori": 90.0, "grating_size": 45.0, "grating_speed": 0.015}
...
# Rule Switching Mode =========================================
RULE_SWITCH_INITIAL_WAIT = 30 # wait for n trials bevore checking for rule switching
RULE_SWITCH_RANGE = 12 # range of trials for checking for rule switching
RULE_SWITCH_CORRECT = 9 # number of correct trials for rule switching

# Fade away ===================================================
FADE_START = 1900 # from center to left side where stimulus fade away begins
