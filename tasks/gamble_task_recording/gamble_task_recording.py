...
for trial in range(settings_obj.trial_num):
    ...
    sma.add_state(
        ...
        output_actions=[('BNC1',1),('BNC2',1)], #("SoftCode", settings_obj.SC_START_LOGGING)
    )
    ...
    sma.add_state(
        ...
        output_actions=[('BNC1',1)] # switch back to 0,
    )
    sma.add_state(
    ...
    sma.add_state(
        ...
        output_actions=[('BNC1',1),('BNC2',1)] #("SoftCode", settings_obj.SC_END_LOGGING)
    )
